	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
                ...
                @auth
                    ...
                    @elseif (Auth::user()->utype === 'MNG')    
                        <li class="login-form"> <a href="#" title="Register">{{Auth::user()->name}} (Menagere)</a>
                            <ul class="drop-down one-column hover-fade">
                                <li><a href="{{route('menagere.dashboard')}}">Dashboard</a></li>
                                <li><a href="">Service Categories</a></li>
                                <li><a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a></li>     
                    ...
                    @else
                        <li class="login-form"> <a href="#" title="Register">{{Auth::user()->name}}  (Client(e))</a>
                            <ul class="drop-down one-column hover-fade">
